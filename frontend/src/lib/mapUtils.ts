...
// Fill / label / stroke colors for the clustered event markers. Dark mode uses
// the glowing-cyan brand accent at full opacity so markers and clusters read
// clearly against the dark basemap; light mode keeps the indigo accent.
export function getEventMarkerStyle(theme: "light" | "dark") {
	return theme === "dark"
		? { fill: "#00f0ff", text: "#03242b", stroke: "rgba(3, 32, 38, 0.65)" }
		: { fill: "#4f46e5", text: "#ffffff", stroke: "rgba(255, 255, 255, 0.9)" };
}
