  ...
  return (
    <ProtectedRoute>
      <div className="mx-auto max-w-xl px-4 py-8 sm:px-6 lg:px-8">
        <h1 className="mb-6 text-2xl font-bold text-(--sea-ink)">Settings</h1>
        <div className="rounded-lg border border-(--line) bg-(--surface-strong) p-6">
          <SettingsForm />
        </div>
        <div className="mt-4 rounded-lg border border-(--line) bg-(--surface-strong) p-6">
          <h2 className="mb-3 text-lg font-semibold text-(--sea-ink)">Notifications</h2>
